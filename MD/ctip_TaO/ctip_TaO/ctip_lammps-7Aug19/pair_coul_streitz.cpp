...
void *PairCoulStreitz::extract(const char *str, int &dim)
{
  ...
  if (strcmp(str,"chi") == 0 && qeq_x) {
    ...
    for (int i = 1; i <= atom->ntypes; i++)
      ...
      if (map[i] >= 0) qeq_x[i] = params[elem2param[map[i]]].chi;
      else qeq_x[i] = 0.0;
    return (void *) qeq_x;
  }
  if (strcmp(str,"eta") == 0 && qeq_j) {
    ...
    for (int i = 1; i <= atom->ntypes; i++)
      ...
      if (map[i] >= 0) qeq_j[i] = params[elem2param[map[i]]].eta;
      else qeq_j[i] = 0.0;
    return (void *) qeq_j;
  }
  if (strcmp(str,"gamma") == 0 && qeq_g) {
    ...
    for (int i = 1; i <= atom->ntypes; i++)
      ...
      if (map[i] >= 0) qeq_g[i] = params[elem2param[map[i]]].gamma;
      else qeq_g[i] = 0.0;
    return (void *) qeq_g;
  }
  if (strcmp(str,"zeta") == 0 && qeq_z) {
    ...
    for (int i = 1; i <= atom->ntypes; i++)
      ...
      if (map[i] >= 0) qeq_z[i] = params[elem2param[map[i]]].zeta;
      else qeq_z[i] = 0.0;
    return (void *) qeq_z;
  }
  if (strcmp(str,"zcore") == 0 && qeq_c) {
    ...
    for (int i = 1; i <= atom->ntypes; i++)
      ...
      if (map[i] >= 0) qeq_c[i] = params[elem2param[map[i]]].zcore;
      else qeq_c[i] = 0.0;
    return (void *) qeq_c;
  }
